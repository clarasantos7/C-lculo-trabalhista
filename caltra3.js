function calcula(){
    ...
    const vh = parseFloat(document.getElementById(`salario`).value);
    const ht = parseFloat(document.getElementById(`horas`).value);
    const valet = document.getElementById(`vale`).value;
    const outrasd = parseFloat(document.getElementById(`dedu`).value);
    var mensagemre = document.getElementById("resultado");
